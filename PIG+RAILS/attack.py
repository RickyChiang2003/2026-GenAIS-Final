...
class Hacker(object):
    def __init__(self, attack_model_path, attack_model_name, target_model_path, target_model_name, eval_model_path,
        ...
        self.target_model = self.attack_model if target_model_path == attack_model_path else self.load_model(target_model_path, target_model_name)
...
if __name__ == '__main__':
    ...
    print(f"total time cost: {execution_time:.4f} sec") 